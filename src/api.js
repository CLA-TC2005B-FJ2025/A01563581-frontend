const apiBaseUrl = process.env.REACT_APP_API_BASE_URL || 'https://psychic-telegram-r4797qpj5jx72pqq-5000.app.github.dev/'; // Asegúrate de tener REACT_APP_API_BASE_URL en tu .env
